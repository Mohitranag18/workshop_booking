    ...
    useEffect(() => {
        const fetchWorkshops = async () => {
            try {
                ...
                console.log('My workshops response:', response.data);
    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-4">My Workshop Proposals</h1>
                    <p className="text-gray-600">Track the status of your workshop proposals</p>
                </div>
                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-md">
                    {workshops.length > 0 ? (
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            ...
                                            <div className="mt-2 text-sm text-gray-500">
                                                ...
                                                {workshop.instructor && (
                                                    <p><strong>Instructor:</strong> {workshop.instructor.first_name} {workshop.instructor.last_name}</p>
                                                )}
                                                <p><strong>Terms Accepted:</strong> {workshop.tnc_accepted ? 'Yes' : 'No'}</p>
                                            </div>
                                        </div>
                        ...
                        <div className="text-center py-12">
                            <div className="text-gray-500 text-lg mb-4">No workshop proposals found</div>
                            <Link
                                to="/workshop/propose"
...
export default WorkshopStatusCoordinatorPage;
